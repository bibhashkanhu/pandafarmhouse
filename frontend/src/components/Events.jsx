      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-white/80 font-light leading-relaxed">
              ...
              event. Long tables, open fields, honest food from our own soil,
              and a team that treats your day like our own.
            </p>

            {/* Pricing card */}
            <div className="mt-8 inline-flex items-stretch rounded-2xl overflow-hidden border border-white/15 bg-white/5 backdrop-blur-md">
              <div className="px-5 py-4 border-r border-white/10">
                ...
                <div className="mt-1 flex items-baseline gap-1">
                  ...
                  <span className="font-serif-display text-4xl md:text-5xl text-white leading-none">
                    1,499
                  </span>
                  <span className="text-white/60 text-sm">/hr</span>
                </div>
              </div>
              <div className="px-5 py-4 max-w-xs">
                <div className="text-xs text-white/70 leading-relaxed">
                  Final price is quoted after a quick call — depends on your
                  date, guest count and add-ons.
                  <br />
            ...
            <div className="mt-6 flex items-center gap-3 text-xs text-white/70">
              <PhoneCall className="h-4 w-4 text-[#FBC02D]" />
              Book it — our team will call you back to discuss and finalise
              your date &amp; price.
            </div>
          </motion.div>
        ...
        <div className="mt-12 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
          <div className="text-sm md:text-base text-white/85 font-light leading-relaxed max-w-2xl">
            ...
            seating (up to a comfortable small-gathering size) can be arranged
            on request. Reach out at least 7 days in advance for the best
            experience.
          </div>
          <button
